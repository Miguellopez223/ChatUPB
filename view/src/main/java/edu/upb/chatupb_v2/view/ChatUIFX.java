...
public class ChatUIFX extends Application implements IChatView {
    ...
    // ================================================================
    // CONTROLLER INYECTADO (Desacoplado)
    // ================================================================
    ...
    @Override
    public void init() {
        // La vista ya no instancia los controladores internamente.
        // Se hace en el Main mediante el setter.
    }
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.show();
        // Nota: el onAppStart() lo estamos llamando desde el Main despues del start de JavaFX.
    }
    ...
    private VBox buildProfileCard() {
        ...
        newUserItem.setOnAction(e -> { if(chatController != null) chatController.crearNuevoUsuario(); });
        ...
        userComboBox.setOnAction(e -> {
            ...
            if (sel != null && chatController != null) {
    ...
    private VBox buildContactsCard() {
        ...
        listaContactos.setCellFactory(lv -> new ListCell<>() {
            ...
            protected void updateItem(ContactInfo item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    boolean conn = (chatController != null) && chatController.isConectado(item.getIp());
        ...
        listaContactos.setOnMouseClicked(e -> {
            if (e.getClickCount() == 2) {
                ...
                if (selected != null && chatController != null) {
            ...
            if (sel != null && chatController != null) {
                ...
                confirm.showAndWait().ifPresent(btn -> {
                    if (btn == ButtonType.YES) {
                        chatController.eliminarContacto(sel.getId());
                    }
                });
            }
        });
    ...
    private void enviarAccion() {
        if (contactoActivo == null || chatController == null) return;
    ...
    private void addBubbleFX(VBox panel, String text, String time, boolean isMine,
        ...
        if (!isDeleted && !viewOnce && idMensaje != null && chatController != null) {
    ...
    private static String[] getColoresTemaHex(String idTema) {
        ...
        switch (idTema) {
            case "2": return new String[]{"#E3F2FD", "#42A5F5", "#FFFFFF", "#90CAF9", "#BBDEFB", "#90CAF9", "white", "#333333"};
            case "3": return new String[]{"#FFEBEE", "#EF5350", "#FFFFFF", "#EF9A9A", "#FFCDD2", "#EF9A9A", "white", "#333333"};
            case "4": return new String[]{"#FFFDE7", "#FDD835", "#FFFFFF", "#FFF176", "#FFF9C4", "#FFF176", "#333333", "#333333"};
            case "5": return new String[]{"#F3E5F5", "#AB47BC", "#FFFFFF", "#CE93D8", "#E1BEE7", "#CE93D8", "white", "#333333"};
            default: return new String[]{"#ECEFF1", TEAL, "#E8E8E8", "#B0BEC5", "#E0F2F1", "#80CBC4", "white", "#333333"};
        }
    }

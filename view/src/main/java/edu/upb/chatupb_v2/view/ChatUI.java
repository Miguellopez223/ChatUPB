...
public class ChatUI extends JFrame implements IChatView {
    ...
    // Controlador Inyectado (Desacoplado)
    ...
    public void setChatController(IChatController controller) {
    ...
    private void configurarVentana() {
        ...
        pinnedUnpinButton.addActionListener(e -> {
            if (contactoActivo != null && pinnedMessageId != null && chatController != null) {
        ...
        userComboBox.addActionListener(e -> {
            ...
            if (selectedUser != null && chatController != null) {
                chatController.cambiarUsuario(selectedUser);
            }
        });
        btnAddUser.addActionListener(e -> { if(chatController != null) chatController.crearNuevoUsuario(); });
        ...
        btnMensajeUnico.addActionListener(e -> {
            ...
            if (msg.isEmpty() || contactoActivo == null || chatController == null) return;
            chatController.enviarMensajeUnico(contactoActivo, msg);
        });

        // Evento para cambio de tema
        comboTemas.addActionListener(e -> {
            if (suppressTemaEvent || contactoActivo == null || chatController == null) return;
        ...
        tablaContactos.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && chatController != null) {
                    int row = tablaContactos.getSelectedRow();
                    if (row >= 0 && row < contactosEnMemoria.size()) {
    ...
    private void eliminarContacto() {
        ...
        chatController.eliminarContacto(contacto.getId());
    }
    ...
    private void addBubble(JPanel panel, String text, String time, boolean isMine, boolean confirmed, String idMensaje, boolean pinned, boolean viewOnce) {
        ...
        if (btnViewOnce != null) {
            ...
            if (!isDeleted && idMensaje != null && chatController != null) {
    ...
    public void showNewUserDialog() {
        ...
        if(chatController != null) chatController.guardarNuevoUsuario(name.trim());
    }
    ...
    private void mostrarPopUpMensajeUnico(String texto, String idMensaje) {
        ...
        btnLeido.addActionListener(e -> {
            dialog.dispose();
            if(chatController != null) chatController.abrirMensajeUnico(contactoActivo, idMensaje);
        });
    ...
    private static Color[] getColoresTema(String idTema) {
        ...
        switch (idTema) {
            case "2": return new Color[]{ new Color(230, 240, 250), new Color(200, 220, 245), Color.WHITE, new Color(180, 200, 230), new Color(220, 235, 255), new Color(180, 200, 230) };
            case "3": return new Color[]{ new Color(250, 235, 235), new Color(245, 210, 210), Color.WHITE, new Color(230, 190, 190), new Color(255, 225, 225), new Color(230, 190, 190) };
            case "4": return new Color[]{ new Color(250, 248, 230), new Color(245, 240, 200), Color.WHITE, new Color(230, 220, 180), new Color(255, 250, 215), new Color(230, 220, 180) };
            case "5": return new Color[]{ new Color(242, 235, 250), new Color(225, 210, 245), Color.WHITE, new Color(210, 190, 230), new Color(240, 225, 255), new Color(210, 190, 230) };
            default:  return new Color[]{ new Color(240, 240, 240), new Color(212, 245, 212), Color.WHITE, new Color(210, 210, 210), new Color(255, 248, 220), new Color(210, 200, 160) };
        }
    }
